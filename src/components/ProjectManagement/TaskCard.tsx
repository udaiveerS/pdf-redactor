...
import { Card, CardContent, CardActions, Typography, Box, Chip, Button, CircularProgress, Fade, Grow } from '@mui/material';
...
const TaskCard: React.FC<TaskCardProps> = ({ task, isLoading, onEdit, onDelete }) => {
